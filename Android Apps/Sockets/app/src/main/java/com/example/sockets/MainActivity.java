...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btconect = findViewById(R.id.btcnt);
        btdisconect = findViewById(R.id.btdisc);
        btsndtxt = findViewById(R.id.sndtxt);
        ...
        btdisconect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Disconnect();
            }
        ...
        btsndtxt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    public void Change_leds(boolean status) {
        if (status)
            leds.setImageResource(R.mipmap.on);
        else
            leds.setImageResource(R.mipmap.off);
    }
